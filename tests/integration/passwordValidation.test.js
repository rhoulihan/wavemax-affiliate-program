...
describe('Password Validation Integration Tests', () => {
  ...
  // PR 7: customer registration no longer takes a password (registration-only,
  // no customer login). The customer password-strength tests were removed —
  // there is no password field to validate. Affiliate/admin password validation
  // still exercises the validator below.
