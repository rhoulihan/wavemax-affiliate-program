/**
 * Parent-Iframe Communication Bridge - Inline Version for Mobile
 * This is the working inline script for mobile chrome hiding
 * Paste this directly in your HTML page after the iframe
 */
...
(function() {
    ...
    function sendViewportInfo() {
        ...
        try {
            ...
            console.log('[Parent-Iframe Bridge] Sent viewport info:', info.data);
        } catch (e) {
    ...
    function handleMessage(event) {
        // Security check - allow from any subdomain of wavemax.promo
        const origin = event.origin || event.originalEvent.origin;
        if (!origin.includes('wavemax.promo') && !origin.includes('localhost')) {
            return;
        }
