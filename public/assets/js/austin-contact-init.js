...
(function () {
  ...
  const TRANSLATIONS = {
    ...
    es: {
      ...
      'contact.tiles.wdf.text':          '$1.20/lb, mínimo 10 libras. Listo en 24 horas (mismo día si llega antes de las 11am). Detergente hipoalergénico ecológico incluido.',
    ...
    pt: {
      ...
      'contact.tiles.wdf.text':          '$1.20/lb, mínimo 10 libras. Pronto em 24 horas (mesmo dia para pedidos antes das 11h). Detergente hipoalergênico ecológico incluído.',
    ...
    de: {
      ...
      'contact.tiles.wdf.text':          '$1.20/lb, Mindestmenge 10 Pfund. Fertig in 24 Stunden (am selben Tag bei Aufträgen vor 11 Uhr). Umweltfreundliches hypoallergenes Waschmittel inklusive.',
