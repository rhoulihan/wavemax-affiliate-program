...
(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'landing.commercial.fitness.text': 'Daily towel programs. Volume pricing, flexible drop-off scheduling, no contracts required.',
    ...
    es: {
      ...
      'landing.commercial.fitness.text': 'Programas diarios de toallas. Precios por volumen, programación flexible de entrega en tienda, sin contratos.',
    ...
    pt: {
      ...
      'landing.commercial.fitness.text': 'Programas diários de toalhas. Preços por volume, agendamento flexível de entrega na loja, sem contratos.',
    ...
    de: {
      ...
      'landing.commercial.fitness.text': 'Tägliche Handtuchprogramme. Mengenpreise, flexible Terminplanung für die Abgabe im Geschäft, keine Verträge.',
