...
(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'landing.selfserve.uv.text':       "Every wash cycle's water is treated with our Omni LUX UV system — 99.9% pathogen kill before the water ever touches your clothes.",
    ...
    es: {
      ...
      'landing.selfserve.uv.text':       'El agua de cada ciclo se trata con nuestro sistema Omni LUX UV — 99.9% de eliminación de patógenos antes de que el agua toque tu ropa.',
    ...
    pt: {
      ...
      'landing.selfserve.uv.text':       'A água de cada ciclo é tratada com nosso sistema Omni LUX UV — 99.9% de eliminação de patógenos antes que a água toque suas roupas.',
    ...
    de: {
      ...
      'landing.selfserve.uv.text':       'Das Wasser jedes Waschgangs wird mit unserem Omni LUX UV-System behandelt — 99,9 % Pathogen-Eliminierung, bevor das Wasser Ihre Wäsche berührt.',
