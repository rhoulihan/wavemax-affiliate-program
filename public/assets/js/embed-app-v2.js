...
function initializePageScripts(route) {
    ...
    const pageScripts = {
        ...
        '/claim': ['/assets/js/i18n.js', '/assets/js/language-switcher.js', '/assets/js/scan-session.js', '/assets/js/vendor/firebase-app-compat.js', '/assets/js/vendor/firebase-auth-compat.js', '/assets/js/claim.js'],
