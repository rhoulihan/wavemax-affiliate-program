...
function initializePageScripts(route) {
    ...
    const pageScripts = {
        ...
        '/operator-scan': ['/assets/js/embed-config.js', '/assets/js/i18n.js', '/assets/js/language-switcher.js', '/assets/js/modal-utils.js', '/assets/js/errorHandler.js', '/assets/js/csrf-utils.js', '/assets/js/operator-scan-init.js'],
