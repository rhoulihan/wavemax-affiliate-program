      ...
      socialAuthSection.innerHTML = `
        ...
        <div class="bg-green-50 border border-green-200 rounded-lg p-6">
          <div class="flex items-center justify-center">
            ...
            <div>
              <h4 class="text-green-700 font-semibold text-lg" data-i18n="affiliate.register.successfullyConnectedWith" data-i18n-options='{"provider": "${provider.charAt(0).toUpperCase() + provider.slice(1)}"}'>Successfully Connected with ${provider.charAt(0).toUpperCase() + provider.slice(1)}</h4>
