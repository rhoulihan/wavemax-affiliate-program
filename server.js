...
app.use((req, res, next) => {
  ...
  const directives = {
    ...
    'connect-src': ["'self'", 'https://wavemax.promo', 'https://cdn.jsdelivr.net', 'https://cdnjs.cloudflare.com', 'https://router.project-osrm.org', 'https://graphhopper.com', 'https://api.openrouteservice.org', 'https://valhalla1.openstreetmap.de', 'https://nominatim.openstreetmap.org'],
