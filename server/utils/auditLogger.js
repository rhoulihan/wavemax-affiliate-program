...
const AuditEvents = {
  ...
  ORDER_UNDO: 'ORDER_UNDO',
  ORDER_REOPENED: 'ORDER_REOPENED',

  // Bag-workflow scan / delivery / role-code events
  ...
  // Admin operations
  ADMIN_VIEW_ENV_VARS: 'ADMIN_VIEW_ENV_VARS',
  ADMIN_RESET_RATE_LIMITS: 'ADMIN_RESET_RATE_LIMITS',
  ...
  // Add-on catalog (admin-managed order add-ons)
