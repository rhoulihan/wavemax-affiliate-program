...
const FAQ_POOL = {
  wdf_cost: {
    ...
    a: 'WaveMAX Austin charges $1.20 per pound for wash-dry-fold drop-off with a 10-pound minimum. Drop off your laundry, we wash, dry, and fold it, and you pick it up in person. We use hospital-grade UV-sanitized water and eco-friendly hypoallergenic detergent.'
  },
  wdf_turnaround: {
  ...
  commercial_accounts: {
    ...
    a: 'WaveMAX Austin runs recurring commercial laundry accounts from $0.95 per pound for restaurants, gyms, salons, Airbnb hosts, medical offices, and small hospitality. Volume pricing and same-day turnaround are available — call (512) 553-1674 for a quote.'
  },
  self_serve_pricing: {
  ...
  service_area: {
    ...
    a: 'WaveMAX Austin is a walk-in laundromat serving all of North Austin including Georgian Acres, North Lamar, Wooten, Crestview, and Highland, with customers also coming in from Round Rock, Cedar Park, Pflugerville, Georgetown, and Leander.'
  },
  uv_water: {
  ...
  rundberg_address: {
    ...
    a: 'WaveMAX Laundry Austin is at 825 E Rundberg Ln F1, Austin TX 78753, in Rundberg Square Center at the corner of the North I-35 Frontage Road and E Rundberg Lane. Free parking on-site. Look for the bright blue WaveMAX signage facing Rundberg Lane.'
  }
};
...
const OVERRIDES = {
  ...
  'atxwashdryfold.com': {
    ...
    keywords: 'wash dry fold austin, austin wash dry fold, drop off laundry austin, atx wash dry fold, fluff and fold austin, laundry service austin, wash and fold austin, drop off wash dry fold austin, same day wash and fold austin, drop off wash and fold austin',
    ...
    leadParagraph: 'ATX Wash Dry Fold by WaveMAX Austin is Austin\'s top-rated drop-off laundry service. We wash, dry, and fold your clothes for $1.20 per pound — no contracts, no subscriptions, no hidden fees. Drop off any time between 7am and 10pm, daily, at 825 E Rundberg Lane in North Austin, then pick up your fresh, folded laundry in person. Standard turnaround is 24 hours; same-day available for orders placed by 10am. We serve North Austin and welcome customers from Round Rock, Cedar Park, Pflugerville, Georgetown, and Leander. Hospital-grade UV-sanitized water and hypoallergenic detergent on every order.',
    faqKeys: ['wdf_cost', 'wdf_turnaround', 'oversized_items', 'detergent', 'commercial_accounts']
  },
...
function getFaq(hostname) {
  ...
  const keys = (ov && ov.faqKeys) || ['wdf_cost', 'hours_247', 'self_serve_pricing', 'oversized_items', 'rundberg_address', 'uv_water'];
