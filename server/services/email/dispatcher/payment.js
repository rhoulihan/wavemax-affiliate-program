...
exports.sendV2PaymentRequest = async ({ customer, order, paymentAmount, paymentLinks, qrCodes }) => {
  try {
    ...
    const emailData = {
      ...
      dashboardLink: `https://rundberglaundry.com/embed-app-v2.html?route=/customer-dashboard&affid=${order.affiliateId}`,
      customerLoginLink: `https://rundberglaundry.com/embed-app-v2.html?route=/customer-login&affid=${order.affiliateId}`,
...
exports.sendV2PaymentReminder = async ({ customer, order, reminderNumber, paymentAmount, paymentLinks, qrCodes, maxReminders }) => {
  try {
    ...
    const emailData = {
      ...
      confirmationLink: `https://rundberglaundry.com/embed-app-v2.html?route=/customer-dashboard&affid=${order.affiliateId}&confirmPayment=${order.orderId}`,
      dashboardLink: `https://rundberglaundry.com/embed-app-v2.html?route=/customer-dashboard&affid=${order.affiliateId}`,
      customerLoginLink: `https://rundberglaundry.com/embed-app-v2.html?route=/customer-login&affid=${order.affiliateId}`,
